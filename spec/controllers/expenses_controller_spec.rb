  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved expense as @expense" do
        ...
        post :create, {:expense => { "month" => "invalid value" }}, valid_session
        assigns(:expense).should be_a_new(Expense)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested expense" do
        ...
        Expense.any_instance.should_receive(:update).with({ "month" => "MyString" })
        put :update, {:id => expense.to_param, :expense => { "month" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the expense as @expense" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Expense.any_instance.stub(:save).and_return(false)
        put :update, {:id => expense.to_param, :expense => { "month" => "invalid value" }}, valid_session
        assigns(:expense).should eq(expense)
      end
