...
describe ApplicationsController do
  ...
  let(:valid_attributes) { { "date" => "2016-05-23" } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested application" do
        ...
        Application.any_instance.should_receive(:update).with({ "date" => "2016-05-23" })
        put :update, {:id => application.to_param, :application => { "date" => "2016-05-23" }}, valid_session
      end
